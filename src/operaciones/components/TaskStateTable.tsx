...
export const TaskStateTable = ({ estado, table }: {estado:EstadoTarea, table: boolean}) => {
  ...
  if (estado === "Pendiente")
    return (
      ...
      <div className={`bg-sky-400 w-3 h-3 rounded-full flex items-center justify-center pulse-animation`}>
        ...
        <span className="font-semibold text-sm text-sky-950 ">Pendiente</span>
      </div>
    );
  if (estado === "No Realizado")
    return (
        <div className={`w-[132px] px-2 gap-1 ${table ? 'mx-auto' : ''} h-5 flex justify-around bg-opacity-60 items-center rounded-3xl bg-red-600`}>
        ...
        <span className="font-semibold text-sm text-red-900 ">No Realizado</span>
      </div>
    );
  if (estado === "Programado")
    return (
        ...
        <span className="font-semibold text-sm text-amber-900 ">Programado</span>
      </div>
    );
  if (estado === "Realizado")
    return (
      <div className={`w-min px-2 gap-1 ${table ? 'mx-auto' : ''} h-5 flex justify-around bg-opacity-40 items-center rounded-3xl bg-green-400 `}>
        ...
        <span className="font-semibold text-sm text-green-900 ">Realizado</span>
      </div>
    );
};
